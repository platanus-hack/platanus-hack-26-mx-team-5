...
- Andrea Margarita Maldonado Morales ([@AndMargarita2](https://github.com/AndMargarita2))
- José Raúl Soriano Cazabal ([@joseraulsoriano](https://github.com/joseraulsoriano))
- Kevin Garcia Cristobal ([@kevdev04](https://github.com/kevdev04))
- Aaron Rincon ([@rlaaron](https://github.com/rlaaron))
...
2. Point your local `origin` at **both** repos, so a single `git push` updates each one:
   ...
   git remote set-url --add --push origin https://github.com/platanus-hack/platanus-hack-26-mx-team-5.git
